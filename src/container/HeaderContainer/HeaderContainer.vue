            ...
            <ul class="navbar-nav navbar-align">
						...
						<li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                <img src="https://ca.slack-edge.com/TLX78P71R-U01C67P7C06-b13418a0db4d-512" class="avatar img-fluid rounded-circle me-1" alt="Chris Wood"> <span class="text-dark">Chris Wood</span>
                            </a>
...
<style  scoped>
    .nav-item .indicator {
        background: linear-gradient(90deg, rgba(189,63,151,1) 0%, rgba(211,80,165,1) 35%, rgb(228, 54, 185) 66%);
    }
</style>>
